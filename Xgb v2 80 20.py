...
joblib.dump(le, f"{output_dir}\\label_encoder_XGB_v2_80_20.pkl")
...
joblib.dump(model, f"{output_dir}\\model_XGB_v2_80_20.pkl")
print("Model saved.")
...
pd.DataFrame({'y_true': y_test_labels, 'y_pred': y_pred}).to_csv(
    f"{output_dir}\\Predictions_XGB_v2_80_20.csv", index=False)
...
plt.title('Confusion Matrix - XGBoost v2 (80:20)\n(% of actual class)', fontsize=13)
plt.ylabel('Actual', fontsize=11)
plt.xlabel('Predicted', fontsize=11)
plt.xticks(rotation=45, ha='right', fontsize=8)
plt.yticks(rotation=0, fontsize=8)
plt.tight_layout()
plt.savefig(f"{output_dir}\\ConfusionMatrix_XGB_v2_80_20.png", dpi=120, bbox_inches='tight')
plt.show()
...
}).to_csv(f"{output_dir}\\Results_XGB_v2_80_20.csv", index=False)
print("Results saved.")
