...
joblib.dump(model, f"{output_dir}\\model_RF_v2_70_30.pkl")
print("Model saved.")
...
pd.DataFrame({'y_true': y_test, 'y_pred': y_pred}).to_csv(
    f"{output_dir}\\Predictions_RF_v2_70_30.csv", index=False)
...
print("\n========== RANDOM FOREST RESULTS (v2 70:30) ==========")
...
plt.title('Confusion Matrix - Random Forest v2 (70:30)\n(% of actual class)', fontsize=13)
plt.ylabel('Actual', fontsize=11)
plt.xlabel('Predicted', fontsize=11)
plt.xticks(rotation=45, ha='right', fontsize=8)
plt.yticks(rotation=0, fontsize=8)
plt.tight_layout()
plt.savefig(f"{output_dir}\\ConfusionMatrix_RF_v2_70_30.png", dpi=120, bbox_inches='tight')
plt.show()
...
}).to_csv(f"{output_dir}\\Results_RF_v2_70_30.csv", index=False)
print("Results saved.")
